           ...
           array.map((movie) => {
             return (
               <article className="flex-25 card" >
                  ...
                  <center>
                   <a>
                   <input type="button" value="Open" onClick={() => this.openModal(movie)} />                 
                    </a>
                  </center>

                  <ModalSection clickedId={this.state.id} visible={this.state.visible} movies={this.state.selectedMovie} onClickAway={() => this.closeModal()} onClick={() => this.closeModal()} />
...
render(){
  ...
  return(
    <>
      ...
      <Modal  visible={this.props.visible} width="400" height="300" effect="fadeInUp" onClickAway={this.props.onClickAway}>
      <div>
